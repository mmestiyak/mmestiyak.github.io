...
| --- | --- |
| `/logs/` | Written posts, with client-side search |
...
| `/projects/` | Ventures — software and otherwise (farm, silage) |
...
gate (homepage, CNAME, feed, archive, search index, fingerprinted CSS), and
